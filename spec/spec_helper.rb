...
# The generated `.rspec` file contains `--require spec_helper` which will cause this file to always be loaded,
...
RSpec.configure do |config|
  ...
  #   - http://myronmars.to/n/dev-blog/2013/06/rspecs-new-message-expectation-syntax
